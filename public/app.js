            ...
            productsHtml += `
                <div class="product-row">
                    ...
                    <div class="product-availability">
                        ...
                        <button class="btn-report-product" data-station-id="${st.stationId}" data-product="${pName}" data-status="${isAvail ? 'available' : 'empty'}" title="الإبلاغ عن هذه المادة" aria-label="الإبلاغ عن مادة ${pName} في محطة ${st.stationName}">

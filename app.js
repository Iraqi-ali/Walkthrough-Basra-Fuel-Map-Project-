            ...
            productsHtml += `
                <div class="product-row">
                    ...
                    <div class="product-availability">
                        ...
                        <button class="btn-report-product" data-station-id="${st.stationId}" data-product="${pName}" data-status="${isAvail ? 'available' : 'empty'}" aria-label="الإبلاغ عن هذه المادة" title="الإبلاغ عن هذه المادة">
                ...
                <div class="card-actions" onclick="event.stopPropagation();">
                    ${hasCoords ? `
                        <a href="https://www.google.com/maps/dir/?api=1&destination=${st.lat},${st.lng}" 
                           target="_blank" class="btn-icon-only btn-directions" aria-label="الاتجاهات في خرائط جوجل" title="الاتجاهات في خرائط جوجل">
                            <i class="fas fa-diamond-turn-right"></i>
                        </a>
                    ` : ''}
                    <button class="btn-icon-only btn-report-station" data-station-id="${st.stationId}" aria-label="الإبلاغ عن حالة المحطة" title="الإبلاغ عن حالة المحطة">
                        <i class="fas fa-flag"></i>
                    </button>
                </div>
            </div>

            ...
            productsHtml += `
                <div class="product-row">
                    ...
                    <div class="product-availability">
                        ...
                        <button class="btn-report-product" data-station-id="${st.stationId}" data-product="${pName}" data-status="${isAvail ? 'available' : 'empty'}" title="الإبلاغ عن هذه المادة" aria-label="الإبلاغ عن توفر المادة">
                ...
                <div class="card-actions" onclick="event.stopPropagation();">
                    ${hasCoords ? `
                        <a href="https://www.google.com/maps/dir/?api=1&destination=${st.lat},${st.lng}" 
                           target="_blank" class="btn-icon-only btn-directions" title="الاتجاهات في خرائط جوجل" aria-label="فتح الاتجاهات في خرائط جوجل">

            ...
            productsHtml += `
                <div class="product-row">
                    ...
                    <div class="product-availability">
                        ...
                        <button class="btn-report-product" aria-label="الإبلاغ عن هذه المادة" data-station-id="${st.stationId}" data-product="${pName}" data-status="${isAvail ? 'available' : 'empty'}" title="الإبلاغ عن هذه المادة">
        ...
        card.innerHTML = `
            ...
            <div class="station-card-meta">
                ...
                <div class="card-actions" onclick="event.stopPropagation();">
                    ...
                    ` : ''}
                    <button class="btn-icon-only btn-report-station" aria-label="الإبلاغ عن حالة المحطة" data-station-id="${st.stationId}" title="الإبلاغ عن حالة المحطة">
                        <i class="fas fa-flag"></i>
                    </button>
                </div>
            </div>
